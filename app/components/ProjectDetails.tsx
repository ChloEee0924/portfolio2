...
export default function ProjectDetails({ slug }: { slug: string }) {
    ...
    const title = language === "en" ? project.title : project.title_zh || project.title;
    const summary = language === "en" ? project.summary : project.summary_zh || project.summary;
    const fullDescription =
        language === "en"
            ? project.fullDescription
            : project.fullDescription_zh || project.fullDescription;
    const role = language === "en" ? project.role : project.role_zh || project.role;
